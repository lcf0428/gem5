...
BASE_DIR = "{}/SPEC".format(HOME)               # TODO: change the SPEC directory
GEM5_DIR = "{}/gem5/gem5".format(HOME)        # TODO: change the gem5 directory
BUILD_DIR = "{}/gem5_results/SPEC/build".format(HOME)
RESULTS_DIR = "{}/gem5_results/SPEC/checkpoint/{}".format(HOME, operation_mode)
